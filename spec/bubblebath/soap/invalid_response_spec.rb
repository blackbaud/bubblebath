...
eos
    ...
    it 'should raise an error with the message saying its null and the status code when response is null' do
      stub_response_body = <<eos
<soap:Envelope xmlns:soap="http://schemas.xmlsoap.org/soap/envelope/">
   <soap:Body>
      <SayHelloResponse>
...
eos
      ...
      expect {SayHello.new(id: 123, type: 222, flag: true, notes: 'some notes').result}.to raise_exception("HTTP STATUS: '200', MESSAGE: ' RESPONSE HAS NO CONTENT' ")
    end
  end
end